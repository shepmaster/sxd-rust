...
use xpath::expression::{ExpressionAnd, ExpressionEqual, ExpressionNotEqual, ExpressionFunction};
...
fn expression_function_evaluates_input_arguments() {
    let arg_expr: Box<XPathExpression> = box StubExpression{value: Boolean(true)};
